...
void CircleReaderComponent::resized()
{
    ...
    fb.items.add (juce::FlexItem (lfoCxAmountKnob.flex()).withMinWidth(70.0f).withMinHeight(70.0f).withFlex(1.0));
    fb.items.add (juce::FlexItem (lfoRadiusAmountKnob.flex()).withMinWidth(70.0f).withMinHeight(70.0f).withFlex(1.0));
