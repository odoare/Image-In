...
LineReaderComponent::LineReaderComponent(MapSynthAudioProcessor& p)
    : ReaderComponent(p),
      lineCxKnob(p.apvts, "LineCX", LINECOLOUR),
      lineCyKnob(p.apvts, "LineCY", LINECOLOUR),
      lineLengthKnob(p.apvts, "LineLength", LINECOLOUR),
      lineAngleKnob(p.apvts, "LineAngle", LINECOLOUR),
      lineVolumeKnob(p.apvts, "LineVolume", LINECOLOUR),
      filterFreqKnob(p.apvts, "LineFilterFreq", juce::Colours::yellow),
      filterQualityKnob(p.apvts, "LineFilterQuality", juce::Colours::yellow),
      panKnob(p.apvts, "LinePan", LINECOLOUR),
